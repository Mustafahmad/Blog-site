                    ...
                    <div class="card-body p-4">
                        <div class="media ai-icon d-flex">	
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ms-0">{{ $publish }}</span></h3>
                                <p class="mb-0">Total Published Posts</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget-stat card">
                    <div class="card-body p-4">
                        <div class="media ai-icon d-flex">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ms-0"> {{ $pendingPosts }}</span></h3>
                                <p class="mb-0">Total Pending Posts</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget-stat card">
                    <div class="card-body p-4">
                        <div class="media ai-icon d-flex">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ms-0">{{ $postCount }}</span></h3>
                ...
                <div class="widget-stat card">
                    <div class="card-body p-4">
                        <div class="media ai-icon d-flex">
                            ...
                            <div class="media-body">
                                <h3 class="mb-0 text-black"><span class="counter ms-0">{{$users}}</span></h3>
            ...
            <div class="col-xl-6 col-xxl-6 col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header border-0 pb-0 d-sm-flex flex-wrap d-block">
                        <div class="mb-3">
                            <h4 class="card-title mb-1">Posts Summary</h4>
                            <small class="mb-0">Top contributors of website in last week.</small>
                        </div>
                    ...
                    <div class="card-body tab-content orders-summary pt-3">
                        <div class="tab-pane fade show active" id="Monthly">
                            <div class="d-flex flex-wrap order-manage p-3 align-items-center mb-4">
                                <a href="javascript:void(0);" class="btn fs-22 text-white py-1 btn-success px-4 me-3">{{$publish}}</a>
                                <h4 class="mb-0">New Posts <i class="fa fa-circle text-success ms-1 fs-15"></i></h4>
                                <a href="{{route ('post.index')}}" class="ms-sm-auto mt-sm-0 mt-2 text-success font-w500"> Manage Posts <i class="ti-angle-right ms-1"></i></a>
                            </div>
                                ...
                                <table class="table table-responsive-sm mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:125px;"><strong>Actions</strong></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($recent_post as $item => $recent)
                                        <tr>
                                            <td>
                                                <div class="form-check">
                                            ...
                                            <td><b>{{$item + 1}}</b></td>
                                            <td>{{$recent->title}}.</td>
                                            <td class="recent-stats"><i class="fa fa-circle text-success me-1"></i>{{$recent->status}}</td>
                                            <td class="d-flex">
                                                <a href="{{ route('post.show', $recent->id) }}" class="btn btn-primary shadow btn-xs sharp rounded-circle"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('post.edit', $recent->id) }}" class="btn btn-info shadow btn-xs sharp rounded-circle"><i class="fa fa-pencil"></i></a>
                                                <form action="{{ route('post.destroy', $recent->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                    ...
                    <div class="card-body revenue-chart px-3">
                            <div class="d-flex flex-wrap justify-content-end pe-3 pull-right revenue-chart-bar">
                                <div class="d-flex align-items-end me-4 mb-2">
                                    <img src="assets/images/svg/ic_stat2.svg" height="22" width="22" class="me-2 mb-1" alt="">
                                    <div>
                                ...
                                <div class="d-flex align-items-end mb-2">
                                    <img src="assets/images/svg/ic_stat1.svg" height="22" width="22" class="me-2 mb-1" alt="">
                                    <div>
